...
WHERE pickup_datetime <= dropoff_datetime
    AND DATE_TRUNC('month', pickup_datetime) = partition_date
-- TODO check is pickup_datetime is not in the future and at least 1 month in the past{{
    config(
        materialized='incremental',
        incremental_strategy='append',
        partition_by="partition_date, type",
